...
public class Payload extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1507555100303411328L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Payload\",\"namespace\":\"io.aiven.models\",\"fields\":[{\"name\":\"value\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static io.aiven.models.Payload.Builder newBuilder() {
    return new io.aiven.models.Payload.Builder();
  }
   ...
   * @return A new Payload RecordBuilder
   */
  public static io.aiven.models.Payload.Builder newBuilder(io.aiven.models.Payload.Builder other) {
    if (other == null) {
      return new io.aiven.models.Payload.Builder();
    } else {
      return new io.aiven.models.Payload.Builder(other);
    }
  }
   ...
   * @return A new Payload RecordBuilder
   */
  public static io.aiven.models.Payload.Builder newBuilder(io.aiven.models.Payload other) {
    if (other == null) {
      return new io.aiven.models.Payload.Builder();
    } else {
      return new io.aiven.models.Payload.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Payload>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.aiven.models.Payload.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.aiven.models.Payload other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.value)) {
        this.value = data().deepCopy(fields()[0].schema(), other.value);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.aiven.models.Payload.Builder setValue(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.aiven.models.Payload.Builder clearValue() {
      value = null;
