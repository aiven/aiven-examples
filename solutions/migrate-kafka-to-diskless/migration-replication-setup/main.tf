...
#   source_endpoint_id       = var.external_source_aiven_kafka_endpoint_id_rf2
...
resource "aiven_service_integration" "mm2-primary-svc-integration-rf3-set1" {
  project                  = var.aiven_project_name
  integration_type         = "kafka_mirrormaker"
  source_endpoint_id       = var.external_source_aiven_kafka_endpoint_id_rf3_set1
...
#   project                  = var.aiven_project_name
#   integration_type         = "kafka_mirrormaker"
#   source_endpoint_id       = var.external_source_aiven_kafka_endpoint_id_rf3_set2
