# Overview
This repository provides a comprehensive migration accelerator designed to streamline the process of moving existing Kafka clusters to an Aiven Kafka Diskless Cluster. It offers a structured approach covering discovery, infrastructure provisioning, replication setup, monitoring, and validation. This accelerator utilizes external endpoint connections and multiple migration flows to migration topics in parallel.
