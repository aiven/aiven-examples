...
resource "aiven_kafka_mirrormaker" "mm2_schema_replication_1" {
  ...
  service_name = "${var.service_prefix}-mm2-spoke-1"
...
# // MM2 Hub service integration
resource "aiven_service_integration" "mm2-hub-svc-integration" {
project                  = var.aiven_project_name
...
# // MM2 spoke service integration
resource "aiven_service_integration" "mm2-spoke-svc-integration" {
project                  = var.aiven_project_name
integration_type         = "kafka_mirrormaker"
